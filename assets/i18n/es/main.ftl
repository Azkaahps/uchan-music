...
login-problem-network = Uchan Music no pudo conectarse con Spotify. Revisa tu conexión a internet e inténtalo de nuevo.
...
login-problem-premium = Uchan Music reproduce a través de Spotify Premium y esta cuenta no lo tiene. Inicia sesión con una cuenta Premium para continuar.
...
login-usage-consent = Ayúdanos a estimar cuánta gente usa Uchan Music.
...
login-account-detail = Esta sesión tiene iniciada la sesión en más de una cuenta de Google. Elige la que debe usar Uchan Music.
...
settings-saver-detail = Limita la tasa de fotogramas de las animaciones mientras Uchan Music no está en primer plano, a partir del próximo inicio
...
settings-startup-detail = La pantalla con la que se abre Uchan Music
...
settings-language-detail = El idioma que Uchan Music usa en toda la interfaz
settings-language-system = Sistema
settings-language-search = Buscar un idioma
settings-language-none = No se encontraron idiomas
settings-typeface = Fuente
settings-typeface-detail = La tipografía que Uchan Music usa en toda la interfaz
...
settings-close-to-tray-detail = Mantiene a Uchan Music en segundo plano y continúa reproduciendo después de cerrar su ventana
...
settings-discord-name-sonora = Uchan Music
...
settings-discord-buttons-detail = Enlaces bajo el estado que tus amigos pueden abrir, uno a la pista en su servicio y otro a Uchan Music
...
get-sonora = Consigue Uchan Music
...
settings-widevine-detail = Las pistas de Apple Music están cifradas y necesitan el módulo Widevine de Google. Uchan Music usa la copia que ya tiene un navegador de este equipo, o una que descargó de Google con tu consentimiento.
settings-widevine-none = Las pistas de Apple Music están cifradas y necesitan el módulo Widevine de Google. Ningún navegador de este equipo lo tiene, así que Uchan Music puede descargarlo de Google con tu consentimiento.
...
confirm-uninstall-widevine = Uchan Music eliminará la copia que descargó de Google. Las pistas de Apple Music dejarán de reproducirse hasta que se vuelva a descargar.
widevine-prompt-title = Módulo Widevine
widevine-prompt-wanted = Las pistas de Apple Music están cifradas y necesitan el módulo Widevine de Google. Ningún navegador de este equipo lo tiene. Uchan Music puede descargarlo de los servidores de Google, el mismo archivo que instala Chrome, y guardarlo en su propia carpeta.
...
settings-lastfm-detail = Uchan Music hace scrobbling a través de tu propia cuenta de API de Last.fm. Crea una y pega aquí la clave y el secreto.
...
settings-maloja-detail = Indícale a Uchan Music la dirección de tu servidor Maloja y pega una de sus claves de API.
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music se distribuye sin ninguna garantía. Es software libre y puedes redistribuirlo según los términos de la Licencia Pública General de GNU, versión 3 o posterior. Uchan Music es un cliente no oficial y no está afiliado a Spotify AB.
...
update-available = Ya está disponible Uchan Music { $version }
update-detail = Estás en la versión { $running }. Mira qué ha cambiado o actualiza ahora.
update-detail-notes = Estás en la versión { $running }. Mira qué ha cambiado y luego actualiza Uchan Music igual que lo instalaste.
...
settings-check-updates-detail = Pregunta a GitHub una vez al iniciar si hay una versión más reciente. Uchan Music instala la actualización por su cuenta solo en Windows; en el resto te muestra qué ha cambiado
settings-log = Archivo de registro
settings-log-detail = Lo que Uchan Music escribió mientras se ejecutaba. Adjúntalo a un informe de error
