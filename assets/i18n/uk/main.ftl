...
# tray menu
tray-show = Показати Uchan Music
...
login-problem-network = Uchan Music не змогла зв'язатися зі Spotify. Перевірте інтернет-з'єднання та спробуйте ще раз.
...
login-problem-premium = Uchan Music відтворює музику через Spotify Premium, а цей акаунт його не має. Увійдіть в акаунт з Premium, щоб продовжити.
...
login-usage-consent = Допоможіть нам оцінити, скільки людей користується Uchan Music.
...
login-account-detail = У цій сесії виконано вхід у кілька акаунтів Google. Виберіть той, який має використовувати Uchan Music.
...
settings-saver-detail = Обмежувати частоту кадрів анімації, коли Uchan Music не у фокусі, починаючи з наступного запуску
...
settings-startup-detail = Екран, який Uchan Music відкриває на старті
...
settings-language-detail = Мова інтерфейсу Uchan Music
...
settings-typeface-detail = Шрифт інтерфейсу Uchan Music
...
settings-close-to-tray-detail = Залишає Uchan Music в області сповіщень та продовжує відтворення після закриття вікна
...
settings-discord-buttons-detail = Посилання під статусом, які можуть відкрити друзі: на трек у його сервісі й на Uchan Music
...
get-sonora = Завантажити Uchan Music
...
settings-widevine-detail = Треки Apple Music зашифровані й потребують модуля Widevine від Google. Uchan Music бере копію, яка вже є в браузера, або ту, що завантажила від Google з вашої згоди.
settings-widevine-none = Треки Apple Music зашифровані й потребують модуля Widevine від Google. Жоден браузер тут його не має, тож Uchan Music може завантажити його від Google з вашої згоди.
...
confirm-uninstall-widevine = Uchan Music видалить копію, завантажену від Google. Треки Apple Music перестануть грати, доки модуль не буде завантажено знову.
widevine-prompt-title = Модуль Widevine
widevine-prompt-wanted = Треки Apple Music зашифровані й потребують модуля Widevine від Google. Жоден браузер на цьому комп'ютері його не має. Uchan Music може завантажити його із серверів Google, той самий файл, що встановлює Chrome, і зберігати у власній папці.
...
settings-lastfm-detail = Uchan Music скроблить через ваш власний API-акаунт Last.fm. Створіть його та вставте сюди ключ і секрет.
...
settings-version-detail = Складання Uchan Music, яке зараз запущено
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music постачається без жодних гарантій. Це вільне програмне забезпечення, і ви можете поширювати його на умовах GNU General Public License версії 3 або новішої. Uchan Music — неофіційний клієнт і не пов'язаний зі Spotify AB.
...
update-available = Вийшла Uchan Music { $version }
update-detail = У вас { $running }. Подивіться, що змінилося, або оновіться зараз.
update-detail-notes = У вас { $running }. Подивіться, що змінилося, і оновіть Uchan Music так само, як встановлювали.
...
settings-check-updates-detail = Один раз під час запуску питати GitHub, чи вийшла новіша версія. Uchan Music встановлює оновлення сама лише у Windows, в інших системах показує, що змінилося
settings-log = Файл журналу
settings-log-detail = Що Uchan Music записала під час роботи. Додайте його до звіту про помилку
