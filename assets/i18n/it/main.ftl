...
login-problem-network = Uchan Music non è riuscita a raggiungere Spotify. Controlla la connessione internet e riprova.
...
login-problem-premium = Uchan Music trasmette tramite Spotify Premium e questo account non lo possiede. Accedi con un account Premium per continuare.
...
login-usage-consent = Aiutaci a stimare quante persone usano Uchan Music.
...
login-account-detail = Questa sessione ha effettuato l'accesso a più di un account Google. Scegli quello che Uchan Music deve usare.
...
settings-saver-detail = Limita il frame rate delle animazioni quando Uchan Music non è in primo piano, dal prossimo avvio
...
settings-startup-detail = La schermata che Uchan Music apre all'avvio
...
settings-language-detail = La lingua usata da Uchan Music nell'interfaccia
settings-language-system = Sistema
settings-language-search = Cerca una lingua
settings-language-none = Nessuna lingua trovata
settings-typeface = Carattere
settings-typeface-detail = Il carattere tipografico usato da Uchan Music nell'interfaccia
...
settings-close-to-tray-detail = Mantieni Uchan Music nell'area di notifica e continua la riproduzione dopo la chiusura della finestra
...
settings-discord-buttons-detail = Link sotto lo stato che i tuoi amici possono aprire, uno al brano sul suo servizio e uno a Uchan Music
...
get-sonora = Scarica Uchan Music
...
settings-version-detail = La build di Uchan Music che stai eseguendo
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music viene fornito senza alcuna garanzia. È software libero e puoi ridistribuirlo secondo i termini della GNU General Public License versione 3 o successiva. Uchan Music è non ufficiale e non è affiliato con Spotify AB.
...
update-available = Uchan Music { $version } disponibile
update-detail = Stai usando { $running }. Leggi cosa è cambiato, o aggiorna ora.
update-detail-notes = Stai usando { $running }. Leggi cosa è cambiato, poi aggiorna Uchan Music come l'hai installata.
update-notes = Novità
update-now = Aggiorna
...
settings-check-updates-detail = Chiedi a GitHub una volta all'avvio se è disponibile una versione più recente. Uchan Music installa l'aggiornamento da sola solo su Windows; altrove ti mostra cosa è cambiato
settings-log = File di log
settings-log-detail = Ciò che Uchan Music ha scritto durante l'esecuzione. Allegalo a una segnalazione di bug
