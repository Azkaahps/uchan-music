...
app-hide = Uchan Music ausblenden
...
# tray menu
tray-show = Uchan Music anzeigen
...
login-problem-network = Uchan Music konnte Spotify nicht erreichen. Prüfe deine Internetverbindung und versuche es erneut.
...
login-problem-premium = Uchan Music streamt über Spotify Premium, und dieses Konto hat es nicht. Melde dich mit einem Premium-Konto an, um fortzufahren.
...
login-usage-consent = Hilf uns zu schätzen, wie viele Menschen Uchan Music nutzen.
...
login-account-detail = Diese Sitzung ist bei mehreren Google-Konten angemeldet. Wähle das Konto, das Uchan Music verwenden soll.
...
settings-saver-detail = Bildrate der Animationen begrenzen, wenn Uchan Music nicht im Fokus ist, ab dem nächsten Start
...
settings-startup-detail = Der Bildschirm, mit dem Uchan Music startet
...
settings-language-detail = Die Sprache, die Uchan Music in der Oberfläche verwendet
settings-language-system = System
settings-language-search = Sprache suchen
settings-language-none = Keine Sprache gefunden
settings-typeface = Schriftart
settings-typeface-detail = Die Schrift, die Uchan Music in der Oberfläche verwendet
...
settings-close-to-tray-detail = Uchan Music bleibt nach dem Schließen im System-Tray und spielt weiter
...
settings-discord-buttons-detail = Links unter dem Status, die deine Freunde öffnen können, einer zum Titel bei seinem Dienst und einer zu Uchan Music
...
settings-lastfm-detail = Uchan Music scrobbelt über dein eigenes Last.fm-API-Konto. Lege eines an und füge Schlüssel und Secret hier ein.
...
settings-version-detail = Der Build von Uchan Music, den du verwendest
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music kommt ohne jede Gewährleistung. Es ist freie Software, und du darfst es unter den Bedingungen der GNU General Public License Version 3 oder später weitergeben. Uchan Music ist inoffiziell und steht in keiner Verbindung zu Spotify AB.
...
update-available = Uchan Music { $version } ist da
update-detail = Du hast { $running }. Sieh dir an, was sich geändert hat, oder aktualisiere jetzt.
update-detail-notes = Du hast { $running }. Sieh dir an, was sich geändert hat, und aktualisiere Uchan Music so, wie du es installiert hast.
...
settings-check-updates-detail = Beim Start einmal bei GitHub nachfragen, ob eine neuere Version da ist. Uchan Music installiert das Update nur unter Windows selbst, sonst zeigt es dir, was sich geändert hat
settings-log = Protokolldatei
settings-log-detail = Was Uchan Music beim Laufen geschrieben hat. Häng sie an einen Fehlerbericht an
