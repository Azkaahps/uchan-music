...
login-problem-network = Uchan Music could not reach Spotify. Check your internet connection and try again.
...
login-problem-premium = Uchan Music streams through Spotify Premium, and this account does not have it. Sign in with a Premium account to continue.
...
login-usage-consent = Help us estimate how many people use Uchan Music.
...
login-account-detail = This session is signed in to more than one Google account. Pick the one Uchan Music should use.
...
settings-saver-detail = Cap the frame rate of animations while Uchan Music is not focused, applied from the next launch
...
settings-startup-detail = The screen Uchan Music opens on launch
...
settings-language-detail = The language Uchan Music uses across the interface
settings-language-system = System
settings-language-search = Search a language
settings-language-none = No languages found
settings-typeface = Font
settings-typeface-detail = The typeface Uchan Music uses across the interface
...
settings-close-to-tray-detail = Keep Uchan Music in the system tray and continue playing after its window closes
...
settings-discord-buttons-detail = Links under the status for your friends to open, one to the track on its service and one to Uchan Music
...
settings-widevine-detail = Apple Music tracks are encrypted and need Google's Widevine module. Uchan Music uses one it downloaded from Google with your consent, or else the copy a browser here already has.
settings-widevine-none = Apple Music tracks are encrypted and need Google's Widevine module. No browser here has one, so Uchan Music can download it from Google with your consent.
...
confirm-uninstall-widevine = Uchan Music deletes the copy it downloaded from Google. Apple Music tracks stop playing until it is downloaded again.
widevine-prompt-title = Widevine module
widevine-prompt-wanted = Apple Music tracks are encrypted and need Google's Widevine module. No browser on this computer has one. Uchan Music can download it from Google's servers, the same file Chrome installs, and keep it in its own folder.
widevine-prompt-replace = Apple Music tracks are encrypted and need Google's Widevine module. A browser on this computer has one, and Uchan Music can download Google's own copy to use instead, the same file Chrome installs, kept in its own folder.
...
settings-lastfm-detail = Uchan Music scrobbles through your own Last.fm API account. Create one, then paste the key and the secret here.
...
settings-maloja-detail = Point Uchan Music at your Maloja server and paste one of its API keys.
...
update-available = Uchan Music { $version } is out
update-detail = You are on { $running }. Read what changed, or update now.
update-detail-notes = You are on { $running }. Read what changed, then update Uchan Music the way you installed it.
...
settings-check-updates-detail = Ask GitHub once at startup whether a newer version is out. Uchan Music installs the update itself on Windows only; elsewhere it points you at what changed
settings-log = Log file
settings-log-detail = What Uchan Music wrote while running. Attach it to a bug report
