...
# tray menu
tray-show = Показать Uchan Music
...
login-problem-network = Uchan Music не смогла связаться со Spotify. Проверьте интернет-соединение и попробуйте снова.
...
login-problem-premium = Uchan Music воспроизводит музыку через Spotify Premium, а у этого аккаунта его нет. Войдите в аккаунт с Premium, чтобы продолжить.
...
login-usage-consent = Помогите нам оценить, сколько людей пользуется Uchan Music.
...
login-account-detail = В этой сессии выполнен вход в несколько аккаунтов Google. Выберите тот, который должна использовать Uchan Music.
...
settings-saver-detail = Ограничивать частоту кадров анимации, когда Uchan Music не в фокусе, начиная со следующего запуска
...
settings-startup-detail = Экран, который Uchan Music открывает при старте
...
settings-language-detail = Язык интерфейса Uchan Music
...
settings-typeface-detail = Шрифт интерфейса Uchan Music
...
settings-close-to-tray-detail = Оставлять Uchan Music в системном трее и продолжать воспроизведение после закрытия окна
...
settings-discord-buttons-detail = Ссылки под статусом, которые могут открыть ваши друзья: одна на трек в его сервисе, другая на Uchan Music
...
get-sonora = Скачать Uchan Music
...
settings-widevine-detail = Треки Apple Music зашифрованы и требуют модуля Widevine от Google. Uchan Music берёт копию, которая уже есть у браузера, или ту, что скачала у Google с вашего согласия.
settings-widevine-none = Треки Apple Music зашифрованы и требуют модуля Widevine от Google. Ни у одного браузера здесь его нет, поэтому Uchan Music может скачать его у Google с вашего согласия.
...
confirm-uninstall-widevine = Uchan Music удалит копию, скачанную у Google. Треки Apple Music перестанут играть, пока модуль не будет скачан снова.
widevine-prompt-title = Модуль Widevine
widevine-prompt-wanted = Треки Apple Music зашифрованы и требуют модуля Widevine от Google. Ни у одного браузера на этом компьютере его нет. Uchan Music может скачать его с серверов Google, тот же файл, что ставит Chrome, и хранить в своей папке.
...
settings-lastfm-detail = Uchan Music скробблит через ваш собственный API-аккаунт Last.fm. Создайте его и вставьте сюда ключ и секрет.
...
settings-version-detail = Сборка Uchan Music, которая сейчас запущена
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music поставляется без каких-либо гарантий. Это свободное программное обеспечение, и вы можете распространять его на условиях GNU General Public License версии 3 или новее. Uchan Music — неофициальный клиент и не связан со Spotify AB.
...
update-available = Вышла Uchan Music { $version }
update-detail = У вас { $running }. Посмотрите, что изменилось, или обновитесь сейчас.
update-detail-notes = У вас { $running }. Посмотрите, что изменилось, и обновите Uchan Music так же, как устанавливали.
...
settings-check-updates-detail = Один раз при запуске спрашивать GitHub, вышла ли новая версия. Uchan Music устанавливает обновление сама только в Windows, в остальных системах показывает, что изменилось
settings-log = Файл журнала
settings-log-detail = Что Uchan Music записала во время работы. Приложите его к отчёту об ошибке
