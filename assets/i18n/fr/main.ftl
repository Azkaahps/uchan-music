...
# tray menu
tray-show = Afficher Uchan Music
tray-play = Lire
tray-pause = Pause
...
login-problem-network = Uchan Music n'a pas pu joindre Spotify. Vérifiez votre connexion internet et réessayez.
...
login-problem-premium = Uchan Music diffuse via Spotify Premium, et ce compte ne l'a pas. Connectez-vous avec un compte Premium pour continuer.
...
login-usage-consent = Aidez-nous à estimer combien de personnes utilisent Uchan Music.
...
login-account-detail = Cette session est connectée à plusieurs comptes Google. Choisissez celui que Uchan Music doit utiliser.
...
settings-saver-detail = Limiter la fréquence d'images des animations quand Uchan Music n'est pas au premier plan, à partir du prochain démarrage
...
settings-startup-detail = L'écran sur lequel Uchan Music s'ouvre
...
settings-language-detail = La langue utilisée par Uchan Music dans l'interface
...
settings-typeface-detail = La police utilisée par Uchan Music dans l'interface
...
settings-close-to-tray-detail = Garder Uchan Music dans la zone de notification et poursuivre la lecture après la fermeture de sa fenêtre
...
settings-discord-buttons-detail = Des liens sous le statut que vos amis peuvent ouvrir, l'un vers le titre sur son service et l'autre vers Uchan Music
...
get-sonora = Obtenir Uchan Music
...
settings-lastfm-detail = Uchan Music scrobble via votre propre compte API Last.fm. Créez en un, puis collez ici la clé et le secret.
...
settings-maloja-detail = Indiquez à Uchan Music l'adresse de votre serveur Maloja et collez une de ses clés API.
...
settings-version-detail = La version de Uchan Music que vous utilisez
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music est fourni sans aucune garantie. C'est un logiciel libre, et vous êtes invité à le redistribuer selon les termes de la GNU General Public License version 3 ou ultérieure. Uchan Music n'est pas officiel et n'est pas affilié à Spotify AB.
...
update-available = Uchan Music { $version } est disponible
update-detail = Vous êtes en { $running }. Voyez ce qui a changé, ou mettez à jour maintenant.
update-detail-notes = Vous êtes en { $running }. Voyez ce qui a changé, puis mettez Uchan Music à jour comme vous l'avez installée.
...
settings-check-updates-detail = Demander une fois à GitHub au démarrage si une version plus récente existe. Uchan Music installe la mise à jour elle-même uniquement sous Windows ; ailleurs, elle vous montre ce qui a changé
settings-log = Fichier journal
settings-log-detail = Ce que Uchan Music a écrit pendant son exécution. Joignez-le à un rapport de bogue
