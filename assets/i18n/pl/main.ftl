...
login-problem-network = Uchan Music nie mogła połączyć się ze Spotify. Sprawdź połączenie internetowe i spróbuj ponownie.
...
login-problem-premium = Uchan Music odtwarza muzykę przez Spotify Premium, a to konto go nie ma. Zaloguj się na konto z Premium, aby kontynuować.
...
login-usage-consent = Pomóż nam oszacować, ile osób korzysta z Uchan Music.
...
login-account-detail = W tej sesji zalogowano więcej niż jedno konto Google. Wybierz to, którego ma używać Uchan Music.
...
settings-saver-detail = Ogranicz liczbę klatek animacji, gdy Uchan Music nie jest aktywna, od następnego uruchomienia
...
settings-startup-detail = Ekran otwierany przez Uchan Music po uruchomieniu
...
settings-language-detail = Język interfejsu Uchan Music
...
settings-typeface-detail = Krój pisma używany przez Uchan Music w interfejsie
...
settings-close-to-tray-detail = Pozostaw Uchan Music w zasobniku systemowym i kontynuuj odtwarzanie po zamknięciu okna
...
settings-discord-buttons-detail = Odnośniki pod statusem, które znajomi mogą otworzyć: do utworu w jego serwisie i do Uchan Music
...
get-sonora = Pobierz Uchan Music
...
settings-widevine-detail = Utwory Apple Music są zaszyfrowane i potrzebują modułu Widevine od Google. Uchan Music używa kopii, którą ma już przeglądarka, albo tej, którą pobrała od Google za Twoją zgodą.
settings-widevine-none = Utwory Apple Music są zaszyfrowane i potrzebują modułu Widevine od Google. Żadna przeglądarka tutaj go nie ma, więc Uchan Music może pobrać go od Google za Twoją zgodą.
...
confirm-uninstall-widevine = Uchan Music usunie kopię pobraną od Google. Utwory Apple Music przestaną grać, dopóki moduł nie zostanie pobrany ponownie.
widevine-prompt-title = Moduł Widevine
widevine-prompt-wanted = Utwory Apple Music są zaszyfrowane i potrzebują modułu Widevine od Google. Żadna przeglądarka na tym komputerze go nie ma. Uchan Music może pobrać go z serwerów Google, ten sam plik, który instaluje Chrome, i trzymać w swoim folderze.
...
settings-lastfm-detail = Uchan Music scrobbluje przez twoje własne konto API Last.fm. Załóż je, a potem wklej tutaj klucz i sekret.
...
settings-notice = Copyright © 2026 Uchan Music Contributors. Uchan Music jest dostarczana bez żadnej gwarancji. To wolne oprogramowanie, które możesz rozpowszechniać na warunkach GNU General Public License w wersji 3 lub nowszej. Uchan Music jest nieoficjalnym klientem i nie jest powiązana ze Spotify AB.
...
update-available = Uchan Music { $version } jest dostępna
update-detail = Masz wersję { $running }. Zobacz, co się zmieniło, albo zaktualizuj teraz.
update-detail-notes = Masz { $running }. Zobacz, co się zmieniło, a potem zaktualizuj Uchan Music tak, jak ją zainstalowano.
...
settings-check-updates-detail = Zapytaj GitHuba przy starcie, czy jest nowsza wersja. Uchan Music instaluje aktualizację sama tylko w systemie Windows, w pozostałych pokazuje, co się zmieniło
settings-log = Plik dziennika
settings-log-detail = Co Uchan Music zapisała podczas działania. Dołącz go do zgłoszenia błędu
